...
GeneralRenderer::GeneralRenderer(GLFWwindow *window) : Renderer()
{
...
bool GeneralRenderer::render(GLFWwindow *window)
{
...
void GeneralRenderer::recreateSwapchain(GLFWwindow *window)
{
    m_logicalDevice.getLogicalDevice().waitIdle();
