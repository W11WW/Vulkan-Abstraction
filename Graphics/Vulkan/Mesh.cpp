...
void Mesh::setShape(LogicalDevice& logicalDevice, PhysicalDevice& physicalDevice, MemoryPool& memoryPool, std::string filePath)
{
    ...
    if (!tinyobj::LoadObj(&attrib, &shapes, &materials, &warn, &err, "../Graphics/Mesh/al.obj" )) {
